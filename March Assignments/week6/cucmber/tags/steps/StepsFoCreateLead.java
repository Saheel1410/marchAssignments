...
public class StepsFoCreateLead {
...
@Given("Enter Phone No as 7639981110")
public void enterPhnNo() {
...
public void verifyChangeMade() {
	boolean displayed2 = driver.findElementByXPath("//div[@class='x-panel-header sectionHeaderTitle']").isDisplayed();
